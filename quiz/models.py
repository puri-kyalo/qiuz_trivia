...
class QuizPool(models.Model):
    """
    Represents a rigid 2-hour tournament block hosting active traffic tiers.
...
class PaystackTransaction(models.Model):
    ...
    def __str__(self):
        return f"Ref: {self.paystack_reference} ({self.status})"
    ...
    def save(self, *args, **kwargs):
        ...
        if self.phone_number:
            try:
                ...
                # Keeps original string if normalization fails to prevent data drop
                pass
